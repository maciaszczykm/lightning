...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../resources/conn.JPG}
...
\lstinputlisting[style=customswift,caption=Klasa odpowiedzialna za przechwytywanie ekranu]{../resources/capturer.swift} \label{capt}
...
\bibitem{gpu} {\tt https://developer.apple.com/library/content/\-documentation/GraphicsImaging/Conceptual/CoreImaging/\-ci\_tasks/ci\_tasks.html}. \\Data dostępu -- 20.02.2017.
\bibitem{ledb} {\tt https://botland.com.pl/lancuchy-i-matryce-led/2443-lacuch\-led-rgb-12-mm-ws2801-cyfrowy-adresowany-25-szt.html}. \\Data dostępu -- 27.02.2017. 
\end{thebibliography}

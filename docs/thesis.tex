...
% TODO podręcznik użytkownika, opisac protokoly w teorii
...
\lstinputlisting[style=customswift,caption=Klasa Disco -- przykładowa implementacja animacji]{../resources/animation.swift} \label{anim}
...
\lstinputlisting[style=customswift,caption=Klasa Animations -- miejsce rejestracji animacji]{../resources/animations.swift} \label{anims}
